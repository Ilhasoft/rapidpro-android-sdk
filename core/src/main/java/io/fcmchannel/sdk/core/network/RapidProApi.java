...
import io.fcmchannel.sdk.core.models.FlowStepSet;
...
public interface RapidProApi {
    ...
    Call<ApiResponse<io.fcmchannel.sdk.core.models.Field>> listFields(@Header("Authorization") String token);
    ...
    Call<ApiResponse<io.fcmchannel.sdk.core.models.v1.Contact>> loadContactV1(@Header("Authorization") String token, @Query("urns") String urn);
    ...
    Call<io.fcmchannel.sdk.core.models.v1.Contact> saveContactV1(@Header("Authorization") String token,
                                @Query("uuid") String contactUuid, @Body io.fcmchannel.sdk.core.models.v1.Contact contact);
